...
class PressureHexPlugin final : public yup::AudioProcessor
{
public:
    PressureHexPlugin();
...
private:
    enum ParameterIndex { threshold, ratio, attack, release, knee, focus, lookahead, parameterCount };
    ...
    pressurehex::PressureHexEngine engine;
...
#endif
    std::array<yup::String, 4> presetNames { "Hex Press", "Knee Net", "RMS Latch", "Forward Clamp" };
};
